...
class Cfg():
    def __init__(self, fscriptsolutionpath, curscenrioscript):
        self.fscriptsolutionpath = fscriptsolutionpath
        self.curscenrioscript = curscenrioscript
        self.__Setcfg()
        self.__SetVU()
    ...
    def __SetVU(self):
        ...
        fV_Userfile = str(fV_UserPath) + '/' + self.curscenrioscript + 'v_user.py'
